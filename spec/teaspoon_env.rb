Teaspoon.configure do |config|
  ...
  config.asset_paths = ["spec/javascripts", "spec/javascripts/angular", "spec/javascripts/stylesheets"]
  ...
  config.suite do |suite|
    ...
    suite.matcher = "{spec/javascripts,spec/javascripts/angular,app/assets}/**/*_spec.{js,js.coffee,coffee}"
